...
public class Window extends javax.swing.JFrame
{
    ...
    public static void main(String args[])
    {
        ...
        java.awt.EventQueue.invokeLater(new Runnable()
        {
            public void run()
            {
                ...
                //  Add version
                JLabel title = (JLabel) tools.getComponentByName("title");
    ...
    {//GEN-HEADEREND:event_startButtonAction
        try
        {
            ...
            int loY = tools.getFieldValue("loY");
            int hiY = tools.getFieldValue("hiY");

            int loTime = tools.getFieldValue("loTime");
            int hiTime = tools.getFieldValue("hiTime");
